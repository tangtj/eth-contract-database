...
https://x.com/townhallcom/status/1806508623138316426

https://t.me/super_predators
...
contract PREDATORS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"super predators";
    string private constant _symbol = unicode"PREDATORS";
