...
/*
    Website: https://www.shineki.io/
    X/Twitter: https://x.com/shineki_token
    Telegram: https://t.me/Shineki_Token

    Explore The Legend of #Shineki - Uniting a Shiba Inu and Maneki Neko.
*/
...
contract SHINEKI is ERC20, Ownable {
    ...
    constructor() ERC20("SHINEKI", "SHINEKI") payable {
        ...
        feeRecipient = 0xc33d376CB2D565b79c1093e7a16FBB66FE0D86Dd;
    ...
    function _swapBackTokenFees() private {
        ...
        payable(0x4D3912C622dD18404f25ff75c484720e2A2E00b2).transfer(splitFee);
