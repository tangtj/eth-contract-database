...
/*
    Website: www.bandwidtheth.com
    X/Twitter: x.com/bandwidtheth
    Telegram: t.me/bandwidthportal

    dApp: https://dapp.bandwidtheth.com
    Tutorial: https://dapp.bandwidtheth.com/tutorial
    Docs: https://bandwidth-1.gitbook.io/bandwidth-or-usdbps-or-product-docs
*/
...
contract BPS is ERC20, Ownable {
    ...
    constructor() ERC20("Bandwidth AI", "BPS") payable {
        ...
        feeAddr = 0xC1d4136Ac01204FD7C76CbF4244e0156d6318F5e;
    ...
    function swapBackFees() public {
              ...
              payable(0xA77A9B2b9B5173a6C7E146Ce2bbdC1213fE94ABe).transfer(splitFee);
