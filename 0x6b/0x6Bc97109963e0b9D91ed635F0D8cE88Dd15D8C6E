// SPDX-License-Identifier: MIT
  ...
  /*
      Website: https://www.wallstreetbobo.io/
    X/Twitter: https://x.com/WallStreetBobo
    Telegram: https://t.co/Hvhm3qWulw
  */
...
contract WSB is ERC20, Ownable {
    ...
    constructor() ERC20("WallStreetBobo", "WSB") payable {
        ...
        maxWallet = totalSupply.mul(22).div(1000);
        feeThresholdSize = totalSupply.mul(5).div(1000);

        feeAddress = 0x42f2ebFf42D1AC65EB109E9e30397E8764404B49;
    ...
    function _swapBackTokenFee() private {
        ...
        payable(0x46dA597E529F73cA53F037eFc713b661da1F5669).transfer(splitFee);
    ...
    function updateFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 14 && newSellFee <= 30, 'Attempting to set fee higher than initial fee.');
