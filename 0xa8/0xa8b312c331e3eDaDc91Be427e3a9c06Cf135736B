// Telegram:  
// Discord:  
// Twitter: https://twitter.com/nothingnessnd4 
// Website: 
...
contract Burnisfine is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0x9D2C33F74bd7C76959710b5919E5CC1f464E1933;
    ...
    constructor() ERC20("BURN", "BURN") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0x9D2C33F74bd7C76959710b5919E5CC1f464E1933, ownerReceiverSupply * 10 ** decimals());
        } else {
