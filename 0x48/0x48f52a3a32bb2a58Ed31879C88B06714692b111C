...
╚██████╔╝██╔╝ ██╗██████╔╝╚██████╔╝██║ ╚████║██████╔╝███████╗███████╗██║  ██║
 ╚═════╝ ╚═╝  ╚═╝╚═════╝  ╚═════╝ ╚═╝  ╚═══╝╚═════╝ ╚══════╝╚══════╝╚═╝  ╚═╝
Website: https://oxbundler.tech/
Telegram: https://t.me/Oxbundler_bot
Twitter: https://x.com/0xbundlerbot
Bot: https://t.me/Oxbundlerbot
*/
...
contract BNDL is ERC20, Ownable {
   ...
   function removeLimits() external onlyOwner {
    ...
    function SetFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 2 && _sellFee <= 2, "Fees cannot exceed 2%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
