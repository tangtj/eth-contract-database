...
contract Mintable {
    ...
    address private constant _STAKERADDRESS = 0x73a903464f21a3048A73AcAC5bCEDb7d0ef2Da5f;
...
contract Wiz is Context, IERC20, Mintable {
    ...
    function createUniswap() public payable{
        ...
        // unirouter to be changed to justswap router
