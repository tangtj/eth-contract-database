...
/**
//https://t.me/unrektprotocol
//https://www.unrektprotocol.com/
//https://x.com/UnrektProtocol
*/
...
contract Unrekt is ERC20, Ownable {
    ...
    string private constant _name = "Unrekt";
    string private constant _symbol = "UNREKT";
