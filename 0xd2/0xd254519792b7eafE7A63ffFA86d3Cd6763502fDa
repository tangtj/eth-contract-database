...
https://x.com/WatcherGuru/status/1806315157406072871
t.me/vsoleth
...
contract sol is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"VANECK SOLANA TRUST";
    string private constant _symbol = unicode"VSOL";
