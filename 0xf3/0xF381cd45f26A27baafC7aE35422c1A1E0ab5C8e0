/**
First meme coin giving power to ETH stakers with 2500% APY via our Liquid staking derivative mechanism. 

- Exclusive benefits for $BRAINZ holders - Open for All - Staking dApp soon!

🔎Global portal - https://t.me/brainzFinance
Ξ Join TG Chat ➡️ https://t.me/+CvW9pv6s504wZWU0
X: https://x.com/brainzFinance
Web: https://www.brainz.finance/
*/
...
contract ERC20Contract is ERC20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        ExemptFees[marketingFeeReceiver] = true;
        ExemptFees[opsFeeReceiver] = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 amountReceived = (ExemptFees[sender] || ExemptFees[recipient]) ? amount : takeFee(sender, amount, recipient);
    ...
    function manage_feeExempt(address[] calldata addresses, bool status) external onlyOwner {
        require(addresses.length <= 500,"GAS Error: max limit is 500 addresses");
        for (uint256 i=0; i < addresses.length; ++i) {
            ExemptFees[addresses[i]] = status;
        }
    }
