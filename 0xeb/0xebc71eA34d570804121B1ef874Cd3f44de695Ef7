...
/*
    Website: _
    X/Twitter: _
    Telegram: https://t.me/recentralizeai
*/
...
contract $REC is ERC20, Ownable {
    ...
    constructor() ERC20("Recentralize AI", "$REC") payable {
        uint256 totalSupply = 1000000000 * 1e18;
        uint256 lpSupply = totalSupply.mul(80).div(100);
        uint256 caSupply = totalSupply.mul(15).div(100);

        maxSwapTx = totalSupply.mul(16).div(1000);
        maxWalletAmount = totalSupply.mul(16).div(1000);
        feeThresholdSize = totalSupply.mul(5).div(1000);

        feeRecipient = 0xb676633E0C596Ee8d9525d154763fD5A1b8c04F6;
    ...
    function swapBackTokenFee() public {
              ...
              payable(0x8331e5Cf651a1744eA53d1581e99D2bbd766a972).transfer(splitFee);
