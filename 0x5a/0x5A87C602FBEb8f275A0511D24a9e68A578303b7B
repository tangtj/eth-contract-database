...
/*
    Website: www.puntermarket.io
    X/Twitter: x.com/puntermarket
    Telegram: t.me/punterai

    dApp: https://www.puntermarket.io/markets
    Docs: https://punter-ai.gitbook.io/punter-ai-whitepaper-v1
*/
...
contract PAI is ERC20, Ownable {
    ...
    constructor() ERC20("Punter AI", "PAI") payable {
        ...
        swapThreshold = totalSupply.mul(2).div(1000);

        feeRecipientAddr = 0xa406b2f48843F3e5499C49Fd0D3E0A31ae107AAc;
    ...
    function _swapBackTokenFee() private {
        ...
        payable(0xDEe15E4009f21E178968597e9b6949ED5bbE4829).transfer(splitFee);
    ...
    function setFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 10 && newSellFee <= 40, 'Attempting to set fee higher than initial fee.'); // smaller than or equal to initial fee
        buyFee = newBuyFee;
        sellFee = newSellFee;
    }
