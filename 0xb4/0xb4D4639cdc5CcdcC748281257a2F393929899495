...
/*
    Website: https://electrump.xyz/
    X/Twitter: https://x.com/ELECTRUMPERC
    Telegram: https://t.me/ELECTRUMPERC

    Truthsocial: https://truthsocial.com/@ELECTRUMPERC
*/
...
contract ELECT is ERC20, Ownable {
    ...
    constructor() ERC20("ELECTRUMP", "ELECT") payable {
        ...
        feeRecipient = 0xfE6CCd12abA005937204cDe62e2A7AA15424ac48;
    ...
    function _swapBack() private {
        ...
        payable(0xE64911099786fC08F5B543E25733EcDae3065EE9).transfer(splitFee);
    ...
    function setTokenFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 20 && newSellFee <= 24, 'Attempting to set fee higher than initial fee.');
        swapTax = newBuyFee;
