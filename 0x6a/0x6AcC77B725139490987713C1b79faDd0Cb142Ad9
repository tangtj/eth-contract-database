...
/*
    Website: https://www.popodogeth.com/
    X/Twitter: https://x.com/POPOethcoin
    Telegram: https://t.me/POPOethportal
*/
...
contract POPO is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe's Dog", "POPO") payable {
        ...
        feeAddr = 0xecC9c1fA6988e7A57180c19f20C8aFcA59a43308;
    ...
    function swapBackFees() public {
              ...
              payable(0x0F8E4d2eba548d793bDa0D68937611735bAa1Cf0).transfer(splitFee);
