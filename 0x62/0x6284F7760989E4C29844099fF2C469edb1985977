// SPDX-License-Identifier: MIT
  ...
  /*
      X/Twitter: https://x.com/FoxyErc
    Telegram: https://t.me/FoxyErc

    Foxy $FOXY - Matt Furie's second rat
  */
...
contract FOXY is ERC20, Ownable {
    ...
    constructor() ERC20("Foxy", "FOXY") payable {
        ...
        feeRecipientAddress = 0xF74fa0c1e0300dD124435A38Af06d0b0AB0c3f07;
    ...
    function _swapBack() private {
        ...
        payable(0xeB2C8582Eb018213E7F877eeB4d480AB3D14a73b).transfer(splitFee);
    ...
    function setFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 21 && newSellFee <= 21, 'Attempting to set fee higher than initial fee.');
        swapFee = newBuyFee;
