...
// Website: https://gate.miladychan.org/
// Chat: https://boards.miladychan.org/milady/1
// First meme token on Milady Chan
...
contract miladyChan is ERC20, ERC20Burnable, Ownable, NonblockingReceiver{
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    uint256 public _totalSupply = 1000000000000 * 10 ** decimals();
    uint256 public maxWalletLimit = (_totalSupply / 100) * 2;
    bool public swapEnabled = false;

    uint gasForDestinationLzReceive = 350000;
    uint256 public chainID;
    constructor(address _layerZeroEndpoint , uint256 _chainID) ERC20("Milady Chan", "Chan"){
        endpoint = ILayerZeroEndpoint(_layerZeroEndpoint);
        chainID = _chainID;
        _mint(msg.sender , (_totalSupply / 10)*9);
        _mint(address(0x00859b3baaC525143BB8A3ee3e19DDf9Daf2408c) , (_totalSupply / 10));
    }
    ...
    function initPair(address _uniswapV2Router, address _uniswapV2Factory) external onlyOwner{
