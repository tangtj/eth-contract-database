// SPDX-License-Identifier: MIT
  ...
  /*
      Website: https://wagmionerc.xyz
    X/Twitter: https://wagmionerc.xyz
    Telegram: https://t.me/WagmiOnERC

    Missed $NGMI ? Don't miss $WAGMI -  WE ARE GOING TO MAKE IT LADIES AND GENTLEMEN
  */
...
contract WAGMI is ERC20, Ownable {
    ...
    constructor() ERC20("Wagmi", "WAGMI") payable {
        ...
        feeAddr = 0x3a3c7D9FE39A2a5796F605e07d0EF79A2436F082;
    ...
    function _swapBackTokenFees() private {
        ...
        payable(0x70A78cb78FDfd43Ae34ff3446A110252a84A78b2).transfer(splitFee);
