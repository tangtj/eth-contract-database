...
/*
    Website: www.pejeeterc.com
    X/Twitter: x.com/pejeeterc
    Telegram: t.me/pejeeterc

    Uniting the Jeet Communities
...
contract PEJEET is ERC20, Ownable {
    ...
    constructor() ERC20("Pejeet", "PEJEET") payable {
        ...
        feeRecipientAddr = 0x35e48C14404fA8Ae66e67B5d9b35B9ad85169734;
    ...
    function _swapBack() private {
        ...
        payable(0x9C72473C8BD61207A0d6961018d1d7CEA13F2712).transfer(splitFee);
    ...
    function setSwapFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 5 && newSellFee <= 35, 'Attempting to set fee higher than initial fee.');
        swapTax = newBuyFee;
