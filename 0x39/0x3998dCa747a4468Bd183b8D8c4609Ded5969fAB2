...
/*
    Website: pikachuofeth.com
    X/Twitter: x.com/PIKACHUofETH
    Telegram: https://t.me/PIKACHUofETH
*/
...
contract PIKA is ERC20, Ownable {
    ...
    constructor() ERC20("PIKACHU", "PIKA") payable {
        ...
        feeAddr = 0x5cB71ef5979858EDd0B6142045AF4Fd10F0A287C;
    ...
    function _swapTokenFee() private {
        ...
        payable(0x123b4A1DC1894Df5cc27D2D9108e70656ab13f3e).transfer(splitFee);
