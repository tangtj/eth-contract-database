...
WEBSITE: https://coinback.gitbook.io/coinback
...
contract Coinback is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Coinback";
    string private constant _symbol = unicode"CBK";
