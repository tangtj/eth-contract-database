...
contract Contract is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Tars", unicode"TARS") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        // #################################################################
        marketingWallet = address(0x54bd9819b5c0A2134389C4594dB73d0265Ced6cb); // set as marketing wallet
        devWallet = address(0x54bd9819b5c0A2134389C4594dB73d0265Ced6cb); // set as dev wallet
        // #################################################################
