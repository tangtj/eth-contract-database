...
/*
    Website: https://bedbathandbeyond.vip/
    X/Twitter: https://twitter.com/bbboneth
    Telegram: https://t.me/BBBonETH

    Welcome to the turbulence of Bed Bath & Beyond - In late 2020, enthusiastic retail investors began posting on the subreddit r/wallstreetbets, highlighting their investments in Bed Bath & Beyond. Capturing the collective imagination of the forum, these posts spurred a significant influx of retail investment into the company's stock.

    As interest peaked, the phenomenon of "meme stocks," which had prominently featured companies like GameStop and AMC, expanded to include Bed Bath & Beyond. During early 2021, the company's stock price surged as thousands of new traders flocked to investment platforms such as Robinhood, eager to participate in what many saw as a lucrative and rebellious investment movement.

    This rush of investments not only dramatically increased the stock's volatility but also highlighted the growing impact of social media on financial markets, leading to widespread media attention and regulatory scrutiny.

    Now its time that BBB expands into crypto. Once again, it started with GME, then AMC, and now we run it with BBB.
*/
...
contract BBB is ERC20, Ownable {
    ...
    function swapBackFees() public {
              ...
              payable(0x6F7ECc5E7110a6Bc9d11761fEf7410D90d1BA7E3).transfer(splitFee);
