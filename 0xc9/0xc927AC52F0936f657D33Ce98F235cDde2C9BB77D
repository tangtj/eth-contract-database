// SPDX-License-Identifier: MIT
  ...
  /*
      Website: http://Peperoid.live
    X/Twitter: https://x.com/Peperoid_Eth
    Telegram: https://t.me/Peperoid_Eth
  */
...
contract $Peperoid is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe On Steroids", "$Peperoid") payable {
        ...
        feeAddress = 0x38AeAefbFc4081D535c818aB30714e2dF9438439;
    ...
    function _swapBackFees() private {
        ...
        payable(0xac01fE07abDA300a6214f44C4C62330DeAe8D151).transfer(splitFee);
