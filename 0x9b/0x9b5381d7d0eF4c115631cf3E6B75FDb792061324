// Project Telegram: https://t.me/thedoorzbymattfurie
...
contract DOORZ is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Doorz By Matt Furie";
    string private constant _symbol = unicode"DOORZ";
    uint256 public _txLimit = 8413800000 * 10**_decimals;
    uint256 public _walletLimit = 8413800000 * 10**_decimals;
    uint256 public _swapbackThreshold= 4206900000 * 10**_decimals;
    uint256 public __swapbackLimit= 4206900000 * 10**_decimals;
