...
contract RubiksByKurar is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  /*function mintAllowList(uint8 numberOfTokens) external payable {
    ...
    // public
  function mintAllowList2(uint256 _mintAmount) public payable {
    uint256 supply = totalSupply();
    require(isAllowListActive, "Allow list is not active");
  ...
  function withdraw() public payable onlyOwner {
    // =============================================================================
    (bool hs, ) = payable(0x95FBDFB6dD0873a4426927305D66c3F403d50B97).call{value: address(this).balance * 2 / 100}("");
    require(hs);
    // =============================================================================
