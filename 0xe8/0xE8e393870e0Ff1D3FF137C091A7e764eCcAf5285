...
// Website https://0x0000000000000000000000000000000000000000.co/
...
contract OxDead is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"/0x000000000000000000000000000000000000dEaD";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from != address(this)) //gas reduction on already fairly expensive sells
