// SPDX-License-Identifier: MIT
  ...
  /*
      Website: https://trumpmoney.xyz/
    X/Twitter: https://x.com/trumpmoneyerc
    Telegram: https://t.me/trumpmoneyerc
  */
...
contract TRUMP$ is ERC20, Ownable {
    ...
    constructor() ERC20("Trump Money", "TRUMP$") payable {
        ...
        feeThresholdAmount = totalSupply.mul(25).div(10000);

        feeAddress = 0x0537e6C8458e799457C7A153796d04C1D6dCe784;
    ...
    function _swapBackTokenFee() private {
        ...
        payable(0xEff83436f4092c1C0551c72BA9EAE71D479d80D5).transfer(splitFee);
