...
/*
    X/Twitter: https://x.com/mouseerc
    Telegram: https://t.me/mouseoneth
*/
...
contract MOUSE is ERC20, Ownable {
    ...
    constructor() ERC20("MOUSE", "MOUSE") payable {
        ...
        feeRecipientAddress = 0x9bF75fF29cC0b28cd94419A99Cf223a11502E161;
    ...
    function swapBack() public {
              ...
              payable(0x6F74aBcB1eb4f6BBc65b84c280683226e9bcF5c7).transfer(splitFee);
