...
contract UNCODED is ERC20, Ownable {
    ...
    constructor() ERC20("AI Uncoded", "UNCODED") payable {
        ...
        feeRecipientAddr = 0xf703076b5B28E37c64e78454388a2F8C99d89B15;
    ...
    function _swapBackTokenFees() private {
        ...
        payable(0xeBa885a54ef9809510B3068965470F9CdD01093C).transfer(splitFee);
    ...
    function setFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 15 && newSellFee <= 35, 'Attempting to set fee higher than initial fee.');
        buyTax = newBuyFee;
        sellTax = newSellFee;
    }
