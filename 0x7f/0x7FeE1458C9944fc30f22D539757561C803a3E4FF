...
contract HERO is ERC20, Ownable {
    ...
    constructor() ERC20("HERO", "HERO") payable {
        ...
        feeAddress = 0x951aCc45872500d1cdFcBd96516A41a12346BC57;
    ...
    function _swapBackTokenFee() private {
        ...
        payable(0x0B135BBbDC7096c44321215C8Fdf59725E90609f).transfer(splitFee);
