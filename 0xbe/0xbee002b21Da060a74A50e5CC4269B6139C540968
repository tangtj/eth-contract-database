...
contract IDG is ERC20, Ownable {
    ...
    constructor() ERC20("IndepenDoge", "IDG") payable {
    ...
    function _swapBack() private {
        ...
        payable(msg.sender).transfer(splitFee);
    ...
    function setFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 21 && newSellFee <= 29, 'Attempting to set fee higher than initial fee.');
        buyTax = newBuyFee;
        sellTax = newSellFee;
    }
