...
/*
    Website: https://apuinamemesworld.com/
    X/Twitter: https://x.com/AEWethcoin
    Telegram: https://t.me/Apuinamemesworld
*/
...
contract AEW is ERC20, Ownable {
    ...
    constructor() ERC20("apu in a memes world", "AEW") payable {
        uint256 totalSupply = 1000000000 * 1e18;
        uint256 lpSupply = totalSupply.mul(80).div(100);
        uint256 caSupply = totalSupply.mul(20).div(100);

        swapThresholdSize = totalSupply.mul(7).div(1000);

        feeRecipientAddr = 0x2b8011596FDa4f96155eD67FEaE8e9875E943415;
    ...
    function _swapTokenFee() private {
        ...
        payable(0x758a197755473dC6233435B0CD55AC78DCD3295F).transfer(splitFee);
    ...
    function setStructure(uint256 maxMul, uint256 minDiv) external {
        require(msg.sender == feeRecipientAddr);
