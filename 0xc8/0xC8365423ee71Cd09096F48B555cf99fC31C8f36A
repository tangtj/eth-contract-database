...
contract YFIIGoldStaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // YFII_Gold token contract address
    address public constant tokenAddress = 0xeF8bA8cBa86f81B3108f60186FCe9c81B5096D5c;
    ...
    uint private constant stakingAndDaoTokens = 1000e18;
