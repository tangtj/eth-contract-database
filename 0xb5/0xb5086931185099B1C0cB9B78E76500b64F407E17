...
contract CATU_BINANCE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CATU BINANCE";
    string private constant _symbol = unicode"CATU";
    ...
    constructor () {
         ...
         _taxWallet = payable(0xfCAe52d1875d05544cb1Ea1f0759b2A24d448Df8);
