...
contract ClickMiningAI is ERC20, Ownable {
    ...
    uint256 private maxWalletLimitPercent   = 80;
    bool public tradingEnabled;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    event TradingEnabled(bool value);

    constructor (address _marketingWallet, uint256 _launchMul) ERC20("ClickMiningAI", "ClickMiningAI") 
    {   
        marketingWallet = _marketingWallet;
        feeMultiplier = _launchMul;
    ...
    function decrease() external onlyOwner {
        require(feeMultiplier != 1, "Launch Limits removed");
        feeMultiplier -= 1;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromMaxWalletLimit[from]  == false && 
            ...
            require(
                balance + amount <=totalSupply() * maxWalletLimitPercent / 1000, 
