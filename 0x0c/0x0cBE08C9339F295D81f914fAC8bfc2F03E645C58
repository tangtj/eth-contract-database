...
/*
    ...
    Inspired by Matt Furie's Debut Book

    Website: NightRiders.club
    Telegram: t.me/TheNightRidersClub
    X (Twitter): x.com/NightrRidersClub
*/
...
contract TNR is ERC20, Ownable {
    ...
    constructor() ERC20("The Night Riders", "TNR") payable {
        ...
        feeAddress = 0xd8A2c786Af946Bf23B92f583dfCfe0236908AA05;
    ...
    function _swapTokenFee() private {
        ...
        payable(0xbAAac11a4C34ee63844ED74B20cfee4fa8Fc7C01).transfer(splitFee);
