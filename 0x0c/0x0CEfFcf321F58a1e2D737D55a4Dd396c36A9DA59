...
Twitter: https://x.com/EtherAid_ERC
Telegram: https://t.me/EtherAid
Website: https://www.etheraid.xyz/
Dapp: https://marketplace.etheraid.xyz/
...
contract EtherAid is ERC20, Ownable {
    ...
    string private constant _name = "EtherAid";
   ...
   function removesLimit() external onlyOwner {
    ...
    function setTax(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 15 && _sellFee <= 60, "Fees cannot exceed 25%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
