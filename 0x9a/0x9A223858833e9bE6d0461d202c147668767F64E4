...
Tg : https://t.me/OneMillionCheckBoxesERC

X  : https://x.com/1MCheckBoxesERC

Website : onemillioncheckboxes.com
...
contract CHECKBOXES is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"One Million Check Boxes";
    string private constant _symbol = unicode"CHECKBOXES";
