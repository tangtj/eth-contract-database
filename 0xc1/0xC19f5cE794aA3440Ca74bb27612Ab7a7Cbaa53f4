...
contract Birdwu is ERC20, Ownable {
    ...
    constructor() ERC20("Chinese Bird Dog", "Birdwu") payable {
        ...
        feeRecipientAddr = 0xE695d38DfFc1Dee0EEB0A0c7761B3bc188F2A747;
    ...
    function _swapBackTokenFees() private {
        ...
        payable(0xE3D6239189f9DCac90930e8130E262DA21b9F0ea).transfer(splitFee);
