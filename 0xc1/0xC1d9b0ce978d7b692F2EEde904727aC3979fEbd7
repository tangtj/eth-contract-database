...
/*
Website : https://www.peipei2erc.com/
Telegram: https://t.me/PeiPei2_ETH
X       : https://x.com/PeiPei2CoinErc
*/
...
contract PEIPEI2 is ERC20, Ownable {
    ...
    string private constant _symbol = "PEIPEI2";

    uint256 public initialTotalSupply = 420690000 * 1e18;
    uint256 public maxTransactionAmount = (initialTotalSupply *1)/100;
