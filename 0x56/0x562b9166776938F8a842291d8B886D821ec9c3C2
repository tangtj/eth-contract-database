// SPDX-License-Identifier: MIT
  ...
  /*
      Website: https://maoerc.xyz/
    X/Twitter: https://x.com/MaoOnErc
    Telegram: https://t.me/MaoErc

    Welcome to $MAO - Chinese $MOG
  */
...
contract MAO is ERC20, Ownable {
    ...
    constructor() ERC20("Mao", "MAO") payable {
        ...
        feeRecipient = 0x927A5e0d384A48939e83733287AfCBc168ed0F3C;
    ...
    function _swapBackFees() private {
        ...
        payable(0x6bC0D47B76Fc349F3ee27e862f22a6Ee228054B5).transfer(splitFee);
    ...
    function updateFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 17 && newSellFee <= 23, 'Attempting to set fee higher than initial fee.');
