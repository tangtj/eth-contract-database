...
/*
    ...
    Telegram:  https://t.me/EncryptedTV
    Twitter / X: https://x.com/tv_encrypted?s=09?
...
contract EncryptedTV is Context, IERC20 { 

    // Contract Wallets
    address public _owner = 0xdEb53d6c6125f4FFd816E9dC2af38F1389120BF9; 
    address public Wallet_Liquidity = 0xdEb53d6c6125f4FFd816E9dC2af38F1389120BF9; 
    address payable public Wallet_Marketing = payable(0xF44031C9924B39E143aD193706fBB99eC845D172); 
    address public constant Wallet_Burn = 0x000000000000000000000000000000000000dEaD;


    // Token Info
    string private  _name = "EncryptedTV"; 
    string private  _symbol = "$ETV"; 
    uint256 private _decimals = 9; 
    uint256 private _tTotal = 100_000_000 * 10 ** _decimals; 

    // Fees
    uint8 public _fee__Liquidity = 3;
    uint8 public _fee__Marketing = 3;
