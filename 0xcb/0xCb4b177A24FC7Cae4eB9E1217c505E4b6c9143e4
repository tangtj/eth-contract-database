...
contract AntiCancerCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AntiCancerCoin";
    string private constant _symbol = unicode"AntiCancerCoin";
