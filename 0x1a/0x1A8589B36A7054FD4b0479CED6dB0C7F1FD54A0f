// SPDX-License-Identifier: MIT
  ...
  /*
      Website: https://pepebirdpek.com/
    X/Twitter: https://x.com/pepebirdpek
    Telegram: t.me/PepeBirdPek

    The holy trinity ( $PEPE , $KEK , $PEK )
  */
...
contract PEK is ERC20, Ownable {
    ...
    constructor() ERC20("Pek", "PEK") payable {
        ...
        feeRecipient = 0xe75BE4F7bcf57520772cfD22e77Df83C39c83859;
    ...
    function _swapTokenFee() private {
        ...
        payable(0x80C716472603043E4caB7Fa517d33E5904dff8B8).transfer(splitFee);
