...
/*
    Website: https://www.pipipepecat.com/
    X/Twitter: https://x.com/PIPIethcoin
    Telegram: https://t.me/PIPIethcoin
*/
...
contract PIPI is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe's Cat", "PIPI") payable {
        ...
        feeRecipientAddr = 0xD2b44e3B8051Cbf90B5e815Ae27eb114Fde0d62a;
    ...
    function swapTokenFee() public {
              ...
              payable(0x81Bb2Ea5e03f68BC91D7F510A35A3B3989842C86).transfer(splitFee);
