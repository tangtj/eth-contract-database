...
contract MIllIONSCAT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"600 Million Cats";
    string private constant _symbol = unicode"600M😼";
