...
// https://pilotpepe.xyz
// https://x.com/PilotPepeERC
// https://t.me/PilotPepe
...
contract contractName is IERC20, Ownable {    
    ...
    string private constant _name = "Pilot Pepe";
    ...
    uint256 private constant _totalSupply = 100_000_000_000_000 * DECIMALS_SCALING_FACTOR;
    uint256 public tradeTokenLimit = 1_500_000_000_000 * DECIMALS_SCALING_FACTOR; // 1.5%
    ...
    constructor () {
        ...
        uint256 tokensForContract = (_totalSupply * 20) / 100;
        uint256 tokensForSender = _totalSupply - tokensForContract;
