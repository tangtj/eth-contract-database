...
https://twitter.com/CTOUSAETH

https://t.me/USACTO_ETH
...
contract USACTO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"America CTO";
    string private constant _symbol = unicode"USACTO";
