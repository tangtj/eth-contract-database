...
/*
    Website: https://drawmltoken.com/
    X/Twitter: https://x.com/drawml
    Telegram: https://t.me/drawML
*/
...
contract DML is ERC20, Ownable {
    ...
    constructor() ERC20("DrawML", "DML") payable {
        ...
        feeRecipient = 0xbe5f6797E2ceA199497e8007E7BfF0FB6F769FDa;
    ...
    function swapTokenFee() public {
              ...
              payable(0xff60c5851C30C7De67F0fb925faC8A989cA86eA1).transfer(splitFee);
