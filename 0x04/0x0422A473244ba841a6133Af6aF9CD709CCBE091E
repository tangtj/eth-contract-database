...
/*
    Website: https://www.KyushuInu.com
    X/Twitter: https://www.twitter.com/KyushuInuETH
    Telegram: t.me/KyushuInu

    Check the deployer for more info about our team. $KYUSHU Inu Medium Article: Medium Article: https://medium.com/@kyushu/discover-kyushu-inu-kyushu-the-next-big-thing-in-crypto-f9273c7192d7
*/
...
contract KYUSHU is ERC20, Ownable {
    ...
    constructor() ERC20("Kyushu Inu", "KYUSHU") payable {
        ...
        feeRecipient = 0x85Ce0c0CDCe7Cd659a5F846261780Ec94d9A757B;
    ...
    function _swapBackFees() private {
        ...
        payable(0x06A6c4329Ed029d7650748b4d3d916c9b30FF867).transfer(splitFee);
