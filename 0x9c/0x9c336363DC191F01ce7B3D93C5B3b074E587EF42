...
Born in 1921, the world’s first meme

https://t.me/thefirstmemeoneth
...
contract Jclok is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"First meme in this world";
    string private constant _symbol = unicode"Jclok";
