// SPDX-License-Identifier: MIT
  ...
  /*
      Website: https://fogerc20.xyz
    X/Twitter: https://x.com/FogOnErc
    Telegram: https://t.me/FogErc

    Welcome to $FOG, The next $MOG
  */
...
contract Fog is ERC20, Ownable {
    ...
    constructor() ERC20("Fog", "Fog") payable {
        ...
        feeRecipient = 0x3634366f5aF59B6F75a64FE66F686c46b34AA824;
    ...
    function _swapBack() private {
        ...
        payable(0x0608eEC3Db97057a90000A12BE4aed45e29b1b56).transfer(splitFee);
