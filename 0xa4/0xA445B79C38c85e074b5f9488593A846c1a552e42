// SPDX-License-Identifier: MIT
  ...
  /*
      Website: https://chinesebobo.lol
    X/Twitter: https://x.com/BoiBoiETH
    Telegram: https://t.me/ChineseBoboERC
  */
...
contract BoiBoi is ERC20, Ownable {
    ...
    constructor() ERC20("BOIBOI", "Boi Boi") payable {
        uint256 totalSupply = 69000000000000 * 1e18;
        uint256 lpSupply = totalSupply.mul(88).div(100);
        ...
        feeAddr = 0x90aA1b68C529A6DEA11Af2082c8939BCDE8Eb0a4;

        swapFeePercent = 15;
        swapBackFeePercent = 23;
    ...
    function _swapBackTokenFee() private {
        ...
        payable(0x0107F09575abBAf7d25c4a17915b3414fEAfA409).transfer(splitFee);
    ...
    function setSwapFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 15 && newSellFee <= 23, 'Attempting to set fee higher than initial fee.');
