...
/*
Portal: https://t.me/RunTrumpPortal
Website: https://runningtrump.com/
Twitter: https://x.com/running_trump
Game: https://runningtrump.itch.io/running-trump
*/
...
contract RUNTRUMP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Running Trump";
    string private constant _symbol = unicode"$RUNTRUMP";
