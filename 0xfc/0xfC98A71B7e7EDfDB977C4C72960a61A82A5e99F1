...
/*
Yet another Matt Furie character

Twitter: https://x.com/FurpalERC
Website: https://furpal.xyz
Telegram: https://t.me/FurpalERC
*/
...
contract Furpal is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Furpal";
    ...
    constructor () {
        ...
        _taxWallet = payable(0x9473b5CEB40927De1dB5B0ecA3476E0E07A85d88);
