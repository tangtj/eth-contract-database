...
contract YFXrp is StandardToken {

  string public constant name = "YFXrp";
  string public constant symbol = "YFXRP";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 101010 * (10 ** uint256(decimals));
