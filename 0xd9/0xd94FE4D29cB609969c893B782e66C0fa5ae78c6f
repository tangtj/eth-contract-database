...
Telegram :https://t.me/GoathereumERC

Welcome to Goathereum.
meme token based on community, we will do stealth launch for growth organic community, 
so we can go moonshot by easily, we have any marketing plan, and we has set up line callers, 
enjoy here and going to moonshot together.
...
contract GoathereumERC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xcA8F409C855F33503A693bC00B4A3eE92A5d16c2); 
    address payable public Wallet_Dev = payable(0xcA8F409C855F33503A693bC00B4A3eE92A5d16c2);
    ...
    string private constant _name = "Goathereum"; 
    ...
    constructor () {
        ...
        _owner = 0xcA8F409C855F33503A693bC00B4A3eE92A5d16c2;
