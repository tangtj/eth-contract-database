...
contract Poolable{
    ...
    address payable internal constant _POOLADDRESS = 0x941854e039A14515Be3F22bd054f6E914F6cC94e;
...
contract Staker is Poolable{
    ...
    function stake() public payable{
        ...
        require(creationTime + 2415 minutes <= now, "It has not been 40 hours since contract creation yet");
