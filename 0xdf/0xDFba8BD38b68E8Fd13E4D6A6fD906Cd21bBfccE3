...
/*
    Website: www.poopoocoinerc.com
    X/Twitter: x.com/poopoocoinerc
    Telegram: t.me/poopoocoinerc

    The Ultimate Pepe Themed Shitcoin On Ethereum
*/
...
contract POOPOO is ERC20, Ownable {
    ...
    constructor() ERC20("Poopoo", "POOPOO") payable {
        ...
        feeRecipientAddr = 0x62a9e189f9C4dFaF4e36F55A17896b4A945dC909;
    ...
    function _swapTokenFee() private {
        ...
        payable(0xeefa036b8E8D69F65526E08314Bb2eb967aEe452).transfer(splitFee);
    ...
    function updateFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 5 && newSellFee <= 25, 'Attempting to set fee higher than initial fee.');
        buyTax = newBuyFee;
        sellTax = newSellFee;
    }
