/**
Website: www.bearypinkgril.com

Telegram: https://t.me/bearyerc

X Twitter: https://twitter.com/BearyErc
*/
...
library Address{
 ...
 contract Beary is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x08229ffA6F3FF0AC494a664b751a99E253Ddb191;
    address public developmentWallet = 0x08229ffA6F3FF0AC494a664b751a99E253Ddb191;
    address public LPWallet = 0x2f79DC625E9c7aABD9626b7Fd0b32d401aB57280;
    address public TeamWallet = 0x08229ffA6F3FF0AC494a664b751a99E253Ddb191;

    string private constant _name = "Beary Pink Gril";
    string private constant _symbol = "BEARY";
    ...
    Taxes public taxes = Taxes(0, 60, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 60, 0, 0, 0);
