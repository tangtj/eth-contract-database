...
// File: contracts/GoldenDevil.sol
...
contract GoldenDevil is ERC721Enumerable, Ownable {
    ...
    constructor(string memory _customURI) ERC721("GoldenDevil", "GDT") Ownable(msg.sender) {
