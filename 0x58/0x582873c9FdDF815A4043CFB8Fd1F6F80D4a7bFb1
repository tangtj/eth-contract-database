...
contract SAIYA is ERC20, Ownable {
    ...
    constructor() ERC20("Saiya", unicode"YA!") {
        ...
        marketingWallet = address(0xaD05bDF3FCdb731C02B1CFDad8b8C56B4Eebb088); // set as marketing wallet
        devWallet = address(0xaD05bDF3FCdb731C02B1CFDad8b8C56B4Eebb088); // set as dev wallet
