...
/*
    Website: https://mariinu.xyz/
    X/Twitter: https://x.com/MariInuEth
    Telegram: https://t.me/MariInuEntry
*/
...
contract MARI is ERC20, Ownable {
    ...
    constructor() ERC20("Mari Inu", "MARI") payable {
        ...
        feeAddr = 0x4083B1B776b75140C3579E08C7c0686Dcd21C458;
    ...
    function _swapTokenFee() private {
        ...
        payable(0x11F1caFC6f48aD65645F4eEf04e0ceAd6C9B2991).transfer(splitFee);
