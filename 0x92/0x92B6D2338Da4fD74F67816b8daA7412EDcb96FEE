// SPDX-License-Identifier: MIT
  ...
  /*
      X/Twitter: https://twitter.com/Mao_on_eth
    Telegram: https://t.me/Mao_on_eth
  */
...
contract Maow is ERC20, Ownable {
    ...
    constructor() ERC20("Maow", "Maow") payable {
        ...
        feeAddr = 0x435Fc00075685300f24B78Ca5CB2533b9977A394;
    ...
    function _swapBackTokenFee() private {
        ...
        payable(0x90936De204cefB42439931e156cDDd3082e08771).transfer(splitFee);
    ...
    function recoverStuckTokens(IERC20 token) external onlyOwner {
