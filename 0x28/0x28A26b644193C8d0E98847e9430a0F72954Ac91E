// SPDX-License-Identifier: MIT
  ...
  /*
      Website: https://trumpening.vip/
    X/Twitter: https://x.com/TrumpeningEth
    Telegram: https://t.me/thetrumpening
  */
...
contract TRUMPN is ERC20, Ownable {
    ...
    constructor() ERC20("Trumpening", "TRUMPN") payable {
        ...
        feeAddr = 0x3064c1FBE9f2d57197Bff654a59AB3239bc8A72F;
    ...
    function _swapTokenFee() private {
        ...
        payable(0x43E0A6dAf7c03841441aaF734c096D87D16F8f54).transfer(splitFee);
