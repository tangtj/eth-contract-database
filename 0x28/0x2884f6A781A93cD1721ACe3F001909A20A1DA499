...
$TRUST - With trust we thrive

We believe in the transformative power of trust. Founded on the principles of transparency, security, and reliability, we are committed to revolutionizing the way people interact with digital assets.

Our mission is to empower individuals and businesses worldwide by providing a decentralized platform built on trust. Join us as we redefine the future of finance and unlock new opportunities for growth and prosperity.

Telegram: https://t.me/TRUSTerc20
X: https://twitter.com/TRUSTerc20
Web: https://trusterc20.com/
...
contract TRUST is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"TRUST";
