...
/*
    Website: https://praygeerc.com/
    X/Twitter: https://x.com/PraygeErc
    Telegram: https://t.me/Prayge0x777

    Welcome to Prayge $PRAYGE 0x777 

    https://knowyourmeme.com/memes/prayge
*/
...
contract Prayge is ERC20, Ownable {
    ...
    constructor() ERC20("Prayge", "Prayge") payable {
        ...
        feeAddress = 0x04279747e71Be38D1520249562Ad899fD10B06Fa;
    ...
    function _swapBackFees() private {
        ...
        payable(0x297C59C8Bd4cbAAE17E3D160C374b44254f05E5b).transfer(splitFee);
