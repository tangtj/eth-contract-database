// SPDX-License-Identifier: MIT
  ...
  /*
      Website: bookoffurieerc.xyz
    X/Twitter: https://x.com/BookOfFurieErc
    Telegram: https://t.me/BookOfFurieEth

    Welcome To Book Of Furie $BOFU 0x98765
  */
...
contract BOFU is ERC20, Ownable {
    ...
    constructor() ERC20("Book Of Furie", "BOFU") payable {
        ...
        feeAddr = 0x06048fD8c5ccd12d6D35f4FE0A1E9aec89099a1C;
    ...
    function _swapBackTokenFee() private {
        ...
        payable(0x06ED7F83cEe99853394ABCE6aC5a6D30bc5B70dE).transfer(splitFee);
    ...
    function setTokenFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 17 && newSellFee <= 20, 'Attempting to set fee higher than initial fee.');
