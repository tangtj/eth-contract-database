...
contract LORD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"LIBERTY CONSISTS IN THE DIVISION OF POWER. ABSOLUTISM, IN CONCENTRATION OF POWER";
    string private constant _symbol = unicode"LORD ACTON";
