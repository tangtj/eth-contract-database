...
/* https://x.com/miyincoin
// https://t.me/miyincoin
/* https://miyineth.com/
*/
...
contract MIYIN  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Chinese Meme 0x888";
    string private constant _symbol = unicode"MIYIN";
    ...
    function manageBots(address[] memory bots_) external onlyOwner{
