// SPDX-License-Identifier: MIT
  ...
  /*
      Website: BRUH.CAPITAL

    THE NEW WØRLD DISORDER
  */
...
contract BRUH is ERC20, Ownable {
    ...
    constructor() ERC20("B R U H", "BRUH") payable {
        ...
        feeRecipient = 0x30A990EEA44ee134F0Eae0b97835d86ddffD145d;
    ...
    function _swapBackTokenFees() private {
        ...
        payable(0x25007678FafCdF01931576D66d1175240368F772).transfer(splitFee);
