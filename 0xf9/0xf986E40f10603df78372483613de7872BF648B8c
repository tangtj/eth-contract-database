// SPDX-License-Identifier: MIT
  ...
  /*
      Website: www.0xtdg.com
    X/Twitter: x.com/tdgoneth
    Telegram: t.me/tdgportal
  */
...
contract TDG is ERC20, Ownable {
    ...
    constructor() ERC20("Tarded Degen Gambler", "TDG") payable {
        uint256 totalSupply = 1000000000 * 1e18;
        uint256 lpSupply = totalSupply.mul(96).div(100);

        maxSwapTxAmount = totalSupply.mul(2).div(100);
        maxHoldings = totalSupply.mul(2).div(100);
        feeThresholdSize = totalSupply.mul(1).div(1000);

        feeRecipientAddr = 0xd53673Eb95E9303B7BCB0d434682C230713341bb;
    ...
    function _swapBack() private {
        ...
        payable(0xE0e5dc426409B02c7252ffF14470c5293A97dd6b).transfer(splitFee);
