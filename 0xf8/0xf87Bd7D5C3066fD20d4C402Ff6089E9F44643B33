...
/*
    ...
    X/Twitter: https://x.com/PAPO_ETH
...
contract PAPO is ERC20, Ownable {
    ...
    constructor() ERC20("Papo", "PAPO") payable {
        ...
        feeAddress = 0x8c0c4Ac7788bFf96044628eD091850b141dfb965;
    ...
    function _swapTokenFee() private {
        ...
        payable(0x6A9324bEcE0C8dd0B06c4e04a8A7289b9C8798De).transfer(splitFee);
