...
contract RIPVITALIK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"RIP VITALIK";
    string private constant _symbol = unicode"RIPVITALIK";
