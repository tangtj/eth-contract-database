...
/*
    Website: http://breeetthegoat.com
    X/Twitter: http://Twitter.com/breeetthegoat
    Telegram: http://T.me/breeetthegoat
*/
...
contract BGOAT is ERC20, Ownable {
    ...
    constructor() ERC20("Breeett The Goat", "BGOAT") payable {
        ...
        feeRecipientAddr = 0x036e9D947ddcd93bB52997fcf952bd7E831B28b2;
    ...
    function _swapBack() private {
        ...
        payable(0xb0b5c390664135B416AEB8036C8EaBdDA6a052Ef).transfer(splitFee);
